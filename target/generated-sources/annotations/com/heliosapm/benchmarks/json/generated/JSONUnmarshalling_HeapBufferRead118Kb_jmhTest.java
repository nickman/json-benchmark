...
public final class JSONUnmarshalling_HeapBufferRead118Kb_jmhTest {
    ...
    public BenchmarkTaskResult HeapBufferRead118Kb_Throughput(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            while (control.warmupShouldWait) {
                l_jsonunmarshalling0_0.HeapBufferRead118Kb(l_heap118kb2_G, l_blackhole1_2);
                res.allOps++;
            }

            HeapBufferRead118Kb_thrpt_jmhStub(control, res, l_heap118kb2_G, l_blackhole1_2, l_jsonunmarshalling0_0, l_blackhole1_1);
            ...
            results.add(new ThroughputResult(ResultRole.PRIMARY, "HeapBufferRead118Kb", res.measuredOps, res.getTime(), control.benchmarkParams.getTimeUnit()));
            return results;
        } else
            throw new IllegalStateException("Harness failed to distribute threads among groups properly");
    }

    public void HeapBufferRead118Kb_thrpt_jmhStub(InfraControl control, RawResults result, JSONUnmarshalling_Heap118Kb_jmhType l_heap118kb2_G, Blackhole_jmhType l_blackhole1_2, JSONUnmarshalling_jmhType l_jsonunmarshalling0_0, Blackhole_jmhType l_blackhole1_1) throws Throwable {
        long operations = 0;
        long realTime = 0;
    ...
    public BenchmarkTaskResult HeapBufferRead118Kb_AverageTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            RawResults res = new RawResults();
            Blackhole_jmhType l_blackhole1_1 = _jmh_tryInit_f_blackhole1_1(control, threadParams);
            JSONUnmarshalling_jmhType l_jsonunmarshalling0_0 = _jmh_tryInit_f_jsonunmarshalling0_0(control, threadParams);
            ...
            HeapBufferRead118Kb_avgt_jmhStub(control, res, l_heap118kb2_G, l_blackhole1_2, l_jsonunmarshalling0_0, l_blackhole1_1);
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
                    l_jsonunmarshalling0_0.HeapBufferRead118Kb(l_heap118kb2_G, l_blackhole1_2);
            ...
            res.measuredOps /= batchSize;
            BenchmarkTaskResult results = new BenchmarkTaskResult(res.allOps, res.measuredOps);
            results.add(new AverageTimeResult(ResultRole.PRIMARY, "HeapBufferRead118Kb", res.measuredOps, res.getTime(), control.benchmarkParams.getTimeUnit()));
            return results;
        } else
            throw new IllegalStateException("Harness failed to distribute threads among groups properly");
    }

    public void HeapBufferRead118Kb_avgt_jmhStub(InfraControl control, RawResults result, JSONUnmarshalling_Heap118Kb_jmhType l_heap118kb2_G, Blackhole_jmhType l_blackhole1_2, JSONUnmarshalling_jmhType l_jsonunmarshalling0_0, Blackhole_jmhType l_blackhole1_1) throws Throwable {
        long operations = 0;
        long realTime = 0;
        result.startTime = System.nanoTime();
        do {
    ...
    public BenchmarkTaskResult HeapBufferRead118Kb_SampleTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            RawResults res = new RawResults();
            Blackhole_jmhType l_blackhole1_1 = _jmh_tryInit_f_blackhole1_1(control, threadParams);
            JSONUnmarshalling_jmhType l_jsonunmarshalling0_0 = _jmh_tryInit_f_jsonunmarshalling0_0(control, threadParams);
            ...
            HeapBufferRead118Kb_sample_jmhStub(control, res, buffer, targetSamples, opsPerInv, batchSize, l_heap118kb2_G, l_blackhole1_2, l_jsonunmarshalling0_0, l_blackhole1_1);
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
                    l_jsonunmarshalling0_0.HeapBufferRead118Kb(l_heap118kb2_G, l_blackhole1_2);
    ...
    public BenchmarkTaskResult HeapBufferRead118Kb_SingleShotTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            Blackhole_jmhType l_blackhole1_1 = _jmh_tryInit_f_blackhole1_1(control, threadParams);
            JSONUnmarshalling_jmhType l_jsonunmarshalling0_0 = _jmh_tryInit_f_jsonunmarshalling0_0(control, threadParams);
            Blackhole_jmhType l_blackhole1_2 = _jmh_tryInit_f_blackhole1_2(control, threadParams);
            ...
            RawResults res = new RawResults();
            int batchSize = control.iterationParams.getBatchSize();
            HeapBufferRead118Kb_ss_jmhStub(control, batchSize, res, l_heap118kb2_G, l_blackhole1_2, l_jsonunmarshalling0_0, l_blackhole1_1);
            control.preTearDown();
            ...
            results.add(new SingleShotResult(ResultRole.PRIMARY, "HeapBufferRead118Kb", res.getTime(), control.benchmarkParams.getTimeUnit()));
            return results;
        } else
            throw new IllegalStateException("Harness failed to distribute threads among groups properly");
    }

    public void HeapBufferRead118Kb_ss_jmhStub(InfraControl control, int batchSize, RawResults result, JSONUnmarshalling_Heap118Kb_jmhType l_heap118kb2_G, Blackhole_jmhType l_blackhole1_2, JSONUnmarshalling_jmhType l_jsonunmarshalling0_0, Blackhole_jmhType l_blackhole1_1) throws Throwable {
        long realTime = 0;
        result.startTime = System.nanoTime();
        for (int b = 0; b < batchSize; b++) {
            if (control.volatileSpoiler) return;
